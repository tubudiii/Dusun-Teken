    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li class="dropdown"><a href="#" class="{{ Request::is('wilayah', 'sejarah', 'visi-misi', 'perangkat-desa', 'peta-desa', 'data-desa') ? 'active' : '' }}"><span>Profil Desa</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                        ...
                        <li><a href="/perangkat-desa" class="{{ Request::is('perangkat-desa') ? 'active' : '' }}">Perangkat Desa</a></li>
                        <li><a href="/peta-desa" class="{{ Request::is('peta-desa') ? 'active' : '' }}">Peta Desa</a></li>
                        <li><a href="/data-desa" class="{{ Request::is('data-desa') ? 'active' : '' }}">Data Desa</a></li>
                    </ul>
                </li>
